...
Resource.prototype.initializeAddModal = function() {
    ...
    $modal.find('.modal-heading').html('Agregar ' +  this.resourceName);
    $modal.find('.submit-btn').html('Agregar ' + this.resourceName);
...
Resource.prototype.initializeUpdateModal = function(resourceId) {
    ...
    $.ajax({
        ...
        success: function (resource) {
            ...
            // Set up modal title and button label
            $modal.find('.modal-heading').html('Actualizar ' + self.resourceName);
            $modal.find('.submit-btn').html('Guardar');
...
Resource.prototype.initializeDeleteModal = function(resourceId) {
    App.setDeleteForm(this.baseUrl + '/' + resourceId, 'Eliminar ' + this.resourceName);
    App.showConfirmDialog("Deseas eleminar  " + this.resourceNamex + "?");
};
