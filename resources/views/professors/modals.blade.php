    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-heading">Agregar un Nuevo Grado</h4>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
                            ...
                            <div class="form-group">
                                <label>Período no disponible</label>

                                <div class="select2-wrapper">
                                    <select id="periods-select" name="unavailable_periods[]" class="form-control select2" multiple>
                                        <option value="">Seleccione períodos no disponibles para este profesor</option>
                                        @foreach ($days as $day)
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <button type="submit" class="submit-btn btn btn-primary btn-block">Aceptar</button>
                            </div>
                        </div>
                    </div>
                </div>
